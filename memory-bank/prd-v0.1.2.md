# PRD Patch v0.1.2 - Social Media Card Generator
...
- **Padding guidelines:** 120 px safe area left/right/top for all networks; bottom tag bar sits inside its own 80 px bottom gutter. Tags use 120px left/right padding respectively.
